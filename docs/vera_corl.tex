...
\hypersetup{
  pdftitle  = {VERA: Vision-Embodied Knowledge-Reasoning-Action for Closed-Loop Robot Manipulation},
  pdfauthor = {Sara Aly},
}
...
%% ============================================================================
\title{VERA: Vision-Embodied Knowledge-Reasoning-Action for Closed-Loop Robot Manipulation}
...
We present \modelname\ (Vision-Embodied Knowledge-Reasoning-Action), a
...
action-narration and embodied knowledge tokens to attend to the full visual
...
embodied knowledge embeddings toward the goal instruction during training.
...
None closes the embodied knowledge--reasoning feedback loop.
...
No E\textsubscript{emb} / Stream 3b (action narration only)
  & 69.0 & 67.5 & 69.0 & $68.5 \pm 0.7$ \\
No language feedback$^\dagger$
  & 69.6 & 67.6 & 68.6 & $68.6 \pm 0.8$ \\
No E\textsubscript{act} / Stream 3a (embodied knowledge token only)
  & 69.6 & 67.6 & 68.6 & $68.6 \pm 0.8$ \\
...
attends more strongly to $E_{\mathrm{emb}}$ and vision tokens, consistent with
...
We presented \modelname\ (Vision-Embodied Knowledge-Reasoning-Action), a five-stream
...
\caption{Alignment cosine dynamics on Language-Table.
  ...
  embodied knowledge tokens near the instruction embedding; flat BC curves serve
  as a null baseline.}
\label{fig:cosine}
\end{figure}
