%% ============================================================================
%%  VERA: Vision-Experience-Reasoning-Action — CoRL 2025 Submission
%%  Authors: Sara Aly
%%
%%  Style file: corl_2025.sty — download from the CoRL 2025 submission system
%%  (https://corl2025.org/call-for-papers/) and place in the same directory.
%% ============================================================================
\documentclass{article}

%% CoRL 2025 style (PMLR proceedings format).
%% Options: preprint | final | accepted
...
%% CoRL uses natbib with author–year citations (abbrvnat style).
\usepackage{natbib}
...
%% CoRL / PMLR author block.
%% Use \Name{}, \Email{}, and \addr (no backslash) macros provided by corl_2025.sty.
\author{
  \Name{Sara Aly} \Email{sarakhaledsea@gmail.com}\\
  \addr Department of Computer Science, California State University, Northridge
}
...
\bibliographystyle{abbrvnat}    %% CoRL uses author–year (abbrvnat), not plain
