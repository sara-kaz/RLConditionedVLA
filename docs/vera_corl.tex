...
\begin{equation}
  ...
  \quad \lambda_{\mathrm{align}}{=}0.03,\;\lambda_{\mathrm{reg}}{=}0.5
  \label{eq:sft_loss}
\end{equation}
The small $\lambda_{\mathrm{align}}{=}0.03$ reflects that Language-Table's
shaped rewards (${\approx}0.01$--$0.05$) provide weak in-batch contrast;
a larger coefficient competes with the BC term without adding useful gradient.
...
Batch size              & 32    & \\
$\lambda_\mathrm{align}$& 0.03  & InfoNCE weight (small: shaped LT rewards give weak in-batch contrast) \\
