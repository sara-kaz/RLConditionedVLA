...
BC baseline~\citep{lynch2023languagetable}
  & Lang-Table (sim) & ${\sim}$40\% & — \\
Language-Table model~\citep{lynch2023languagetable}
  & Lang-Table (sim) & ${\sim}$68\% & — \\
IAFM~\citep{durante2024agent}
  & Lang-Table (sim) & ${\sim}$65\% & — \\
\midrule
\multicolumn{4}{l}{\textit{CALVIN D$\to$D$^\star$ — 1-task success + chain length (higher is better)}} \\
MCIL~\citep{mees2022calvin}
  & CALVIN D$\to$D & 52.8\% & 0.67 \\
HULC~\citep{mees2022calvin}
  & CALVIN D$\to$D & 91.8\% & 3.06 \\
\bottomrule
...
A policy with 51\% classification accuracy could achieve either high or low
